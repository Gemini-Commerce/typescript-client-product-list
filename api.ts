 ...
 * 
 * @export
 * @interface ProductlistSetProductListAssociationsRequest
 */
export interface ProductlistSetProductListAssociationsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProductlistSetProductListAssociationsRequest
     */
    'tenantId'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface ProductlistSetProductListAssociationsResponse
 */
export interface ProductlistSetProductListAssociationsResponse {
    /**
     * 
     * @type {Array<ProductlistProductListAssociation>}
     * @memberof ProductlistSetProductListAssociationsResponse
     */
    'associations'?: Array<ProductlistProductListAssociation>;
    /**
     * 
...
export const ProductListApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        productListBulkUpdateProductListAssociations: async (body: ProductlistBulkUpdateProductListAssociationsRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('productListBulkUpdateProductListAssociations', 'body', body)
         ...
         * @param {ProductlistSetProductListAssociationsRequest} body 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        setProductListAssociations: async (body: ProductlistSetProductListAssociationsRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('setProductListAssociations', 'body', body)
...
export const ProductListApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createProductList(body: ProductlistCreateProductListRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistCreateProductListResponse>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.createProductList']?.[localVarOperationServerIndex]?.url;
        ...
        async createProductListAssociation(body: ProductlistCreateProductListAssociationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistCreateProductListAssociationResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.createProductListAssociation']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The DeleteProductList endpoint is used to delete an existing collection of products within the system.
        ...
        async deleteProductList(body: ProductlistDeleteProductListRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistDeleteProductListResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.deleteProductList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The DeleteProductListAssociation endpoint is used to delete an association between a collection and a product.
        ...
        async deleteProductListAssociation(body: ProductlistDeleteProductListAssociationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistDeleteProductListAssociationResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.deleteProductListAssociation']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The GetProductListAssociationsByProductGrn endpoint is used to get the associations between a collection and a list of products by product GRN.
        ...
        async getProductListAssociationsByProductGrn(body: ProductlistGetProductListAssociationsByProductGrnRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistGetProductListAssociationsByProductGrnResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.getProductListAssociationsByProductGrn']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The GetProductListByCode endpoint is used to retrieve an existing collection of products within the system.
        ...
        async getProductListByCode(body: ProductlistGetProductListByCodeRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistGetProductListByCodeResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.getProductListByCode']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The GetProductListById endpoint is used to retrieve an existing collection of products within the system.
        ...
        async getProductListById(body: ProductlistGetProductListByIdRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistGetProductListByIdResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.getProductListById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The GetProductListByUrlKey endpoint is used to retrieve an existing collection of products within the system.
        ...
        async getProductListByUrlKey(body: ProductlistGetProductListByUrlKeyRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistGetProductListByUrlKeyResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.getProductListByUrlKey']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The GetProductListsCount endpoint is used to get the number of products associated with a collection.
        ...
        async getProductListsCount(body: ProductlistGetProductListsCountRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistGetProductListsCountResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.getProductListsCount']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The ListProductListAssociations endpoint is used to list the associations between a collection and a list of products.
        ...
        async listProductListAssociations(body: ProductlistListProductListAssociationsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistListProductListAssociationsResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.listProductListAssociations']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The ListProductLists endpoint is used to retrieve a list of existing collections of products within the system.
        ...
        async listProductLists(body: ProductlistListProductListsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistListProductListsResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.listProductLists']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async productListBulkUpdateProductListAssociations(body: ProductlistBulkUpdateProductListAssociationsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.productListBulkUpdateProductListAssociations(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.productListBulkUpdateProductListAssociations']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The SearchProductLists endpoint is used to retrieve a list of existing collections of products within the system.
        ...
        async searchProductLists(body: ProductlistSearchProductListsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistSearchProductListsResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.searchProductLists']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The SearchProductListsByIds endpoint is used to retrieve a list of existing collections of products within the system.
        ...
        async searchProductListsByIds(body: ProductlistSearchProductListsByIdsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistSearchProductListsByIdsResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.searchProductListsByIds']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The SetProductListAssociations endpoint is used to set the associations between a collection and a list of products.
         ...
         * @throws {RequiredError}
         */
        async setProductListAssociations(body: ProductlistSetProductListAssociationsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistSetProductListAssociationsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.setProductListAssociations(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.setProductListAssociations']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The UpdateProductList endpoint is used to update an existing collection of products within the system.
        ...
        async updateProductList(body: ProductlistUpdateProductListRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductlistUpdateProductListResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductListApi.updateProductList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ProductListApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createProductList(body: ProductlistCreateProductListRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistCreateProductListResponse> {
         ...
         * @throws {RequiredError}
         */
        createProductListAssociation(body: ProductlistCreateProductListAssociationRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistCreateProductListAssociationResponse> {
         ...
         * @throws {RequiredError}
         */
        deleteProductList(body: ProductlistDeleteProductListRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistDeleteProductListResponse> {
         ...
         * @throws {RequiredError}
         */
        deleteProductListAssociation(body: ProductlistDeleteProductListAssociationRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistDeleteProductListAssociationResponse> {
         ...
         * @throws {RequiredError}
         */
        getProductListAssociationsByProductGrn(body: ProductlistGetProductListAssociationsByProductGrnRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistGetProductListAssociationsByProductGrnResponse> {
         ...
         * @throws {RequiredError}
         */
        getProductListByCode(body: ProductlistGetProductListByCodeRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistGetProductListByCodeResponse> {
         ...
         * @throws {RequiredError}
         */
        getProductListById(body: ProductlistGetProductListByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistGetProductListByIdResponse> {
         ...
         * @throws {RequiredError}
         */
        getProductListByUrlKey(body: ProductlistGetProductListByUrlKeyRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistGetProductListByUrlKeyResponse> {
         ...
         * @throws {RequiredError}
         */
        getProductListsCount(body: ProductlistGetProductListsCountRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistGetProductListsCountResponse> {
         ...
         * @throws {RequiredError}
         */
        listProductListAssociations(body: ProductlistListProductListAssociationsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistListProductListAssociationsResponse> {
         ...
         * @throws {RequiredError}
         */
        listProductLists(body: ProductlistListProductListsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistListProductListsResponse> {
         ...
         * @throws {RequiredError}
         */
        productListBulkUpdateProductListAssociations(body: ProductlistBulkUpdateProductListAssociationsRequest, options?: RawAxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.productListBulkUpdateProductListAssociations(body, options).then((request) => request(axios, basePath));
        },
        /**
         * The SearchProductLists endpoint is used to retrieve a list of existing collections of products within the system.
         * @summary Search Collections
         ...
         * @throws {RequiredError}
         */
        searchProductLists(body: ProductlistSearchProductListsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistSearchProductListsResponse> {
         ...
         * @throws {RequiredError}
         */
        searchProductListsByIds(body: ProductlistSearchProductListsByIdsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistSearchProductListsByIdsResponse> {
         ...
         * @throws {RequiredError}
         */
        setProductListAssociations(body: ProductlistSetProductListAssociationsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistSetProductListAssociationsResponse> {
            return localVarFp.setProductListAssociations(body, options).then((request) => request(axios, basePath));
        },
        /**
         * The UpdateProductList endpoint is used to update an existing collection of products within the system.
         * @summary Update Collection
         ...
         * @throws {RequiredError}
         */
        updateProductList(body: ProductlistUpdateProductListRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProductlistUpdateProductListResponse> {
...
export class ProductListApi extends BaseAPI {
     ...
     * @memberof ProductListApi
     */
    public productListBulkUpdateProductListAssociations(body: ProductlistBulkUpdateProductListAssociationsRequest, options?: RawAxiosRequestConfig) {
        return ProductListApiFp(this.configuration).productListBulkUpdateProductListAssociations(body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductListApi
     */
    public setProductListAssociations(body: ProductlistSetProductListAssociationsRequest, options?: RawAxiosRequestConfig) {
        return ProductListApiFp(this.configuration).setProductListAssociations(body, options).then((request) => request(this.axios, this.basePath));
    }
