...
import {
    ...
    ProductlistSetProductListAssociationsRequestFromJSON,
    ProductlistSetProductListAssociationsRequestToJSON,
    ProductlistSetProductListAssociationsResponseFromJSON,
    ProductlistSetProductListAssociationsResponseToJSON,
...
export interface SetProductListAssociationsRequest {
...
export class ProductListApi extends runtime.BaseAPI {
    ...
    /**
     */
    async productListBulkUpdateProductListAssociationsRaw(requestParameters: ProductListBulkUpdateProductListAssociationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling productListBulkUpdateProductListAssociations.');
        }
    ...
    /**
     */
    async productListBulkUpdateProductListAssociations(requestParameters: ProductListBulkUpdateProductListAssociationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.productListBulkUpdateProductListAssociationsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async setProductListAssociationsRaw(requestParameters: SetProductListAssociationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProductlistSetProductListAssociationsResponse>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling setProductListAssociations.');
        }
        ...
        const response = await this.request({
            path: `/productlist.ProductList/SetProductListAssociations`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ProductlistSetProductListAssociationsRequestToJSON(requestParameters.body),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ProductlistSetProductListAssociationsResponseFromJSON(jsonValue));
    }
     ...
     * Set Collection/Product Associations
     */
    async setProductListAssociations(requestParameters: SetProductListAssociationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProductlistSetProductListAssociationsResponse> {
        const response = await this.setProductListAssociationsRaw(requestParameters, initOverrides);
        return await response.value();
    }
